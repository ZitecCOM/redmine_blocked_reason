...
unless ProjectsHelper.included_modules.include? RedmineBlockedReason::BlockedReasonProjectsHelperPatch
  ProjectsHelper.send(:include, RedmineBlockedReason::BlockedReasonProjectsHelperPatch)
end
